...
ACP ([Agent Client Protocol](https://agentclientprotocol.com)) server adapter for [Spirit](https://github.com/SpiritAgents/SpiritAgent). Exposes the same agent runtime as Desktop and CLI over **stdio / ndJSON**, so ACP-compatible editors (for example **Zed** or **JetBrains Junie**) can use Spirit without bespoke integration.

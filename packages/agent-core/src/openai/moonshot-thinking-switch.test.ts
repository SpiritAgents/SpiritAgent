...
test('isMoonshotThinkingSwitchEligibleModel covers kimi-k2.5+ except excluded variants', () => {
  ...
  assert.equal(isMoonshotThinkingSwitchEligibleModel('kimi-k3'), false);
  assert.equal(isMoonshotThinkingSwitchEligibleModel('moonshotai/kimi-k2.5'), true);
});

test('isMoonshotThinkingSwitchExcludedModel blocks v1, k2.7-code, and kimi-k3', () => {
  ...
  assert.equal(isMoonshotThinkingSwitchExcludedModel('kimi-k3'), true);
  assert.equal(isMoonshotThinkingSwitchExcludedModel('moonshotai/kimi-k3'), true);
...
test('isMoonshotThinkingSwitchModel resolves direct and gateway providers', () => {
  ...
  assert.equal(isMoonshotThinkingSwitchModel(gatewayK3), false);
});

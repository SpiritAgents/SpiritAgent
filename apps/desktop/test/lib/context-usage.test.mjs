...
test("normalizeContextUsageSnapshot accepts valid snapshots and recomputes percent", () => {
  ...
  assert.deepEqual(normalizeContextUsageSnapshot({ inputTokens: 64000, contextLength: 128000 }), {
    inputTokens: 64000,
    contextLength: 128000,
    percent: buildContextUsagePercent(64000, 128000),
  });
  assert.equal(normalizeContextUsageSnapshot(null), undefined);
  assert.equal(
    normalizeContextUsageSnapshot({ inputTokens: -1, contextLength: 128000 }),
    undefined,
  );

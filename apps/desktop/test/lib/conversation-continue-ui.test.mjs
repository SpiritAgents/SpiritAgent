...
test("resolveTurnContinuePresentation anchors Continue on last assistant row when tools follow thinking", () => {
  const messages = [
    ...
    },
    {
      ...
      content: "",
      pending: false,
      tool: { toolName: "read_file", phase: "running", headline: "x", detailLines: [] },
    },
    {
      id: 4,
      role: "assistant",
      content: "",
      pending: false,
      tool: { toolName: "glob", phase: "preview", headline: "y", detailLines: [] },
    },
  ];
...
test("shouldShowContinueToolbarOnProcessGroup when continuable thinking is sealed in a process card", () => {
  const messages = [
    ...
    },
    {
      ...
      content: "",
      pending: false,
      tool: { toolName: "glob", phase: "running", headline: "x", detailLines: [] },
    },
  ];

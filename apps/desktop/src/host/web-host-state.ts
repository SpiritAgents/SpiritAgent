import type { DesktopWebHostPolicySnapshot, DesktopWebHostStatusSnapshot } from "../types.js";
...
export function setDesktopWebHostRuntimeStatus(status: DesktopWebHostStatusSnapshot): void {

import spiritAgentIconTranslucencyUrl from "../../build/icon.png?url";
...
/** translucency 顶栏：黑底打包标（`build/icon.png`，图案占画布比例小于透明标） */
export const SPIRIT_AGENT_ICON_TRANSLUCENCY_SRC = spiritAgentIconTranslucencyUrl;

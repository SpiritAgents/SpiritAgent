...
export const ASK_CHIP_CLASS = `inline-flex items-center gap-1 rounded-md bg-emerald-500/10 px-1.5 py-0.5 text-xs ${FONT_WEIGHT_NORMAL} leading-none text-emerald-900 select-none align-middle mx-0.5 dark:bg-emerald-500/15 dark:text-emerald-500`;

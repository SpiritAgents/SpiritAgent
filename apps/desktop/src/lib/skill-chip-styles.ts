...
export const SKILL_CHIP_CLASS = `inline-flex items-center px-0.5 py-0.5 text-xs ${FONT_WEIGHT_NORMAL} leading-none text-yellow-600 select-none align-middle mx-0.5 dark:text-amber-400`;

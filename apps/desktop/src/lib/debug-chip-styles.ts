...
export const DEBUG_CHIP_CLASS = `inline-flex items-center gap-1 rounded-md bg-red-500/10 px-1.5 py-0.5 text-xs ${FONT_WEIGHT_NORMAL} leading-none text-red-700 select-none align-middle mx-0.5 dark:bg-red-500/15 dark:text-red-400`;

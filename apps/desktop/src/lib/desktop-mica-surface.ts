...
export const DESKTOP_MICA_CONTENT_TINT_CLASS = "bg-background/45";

/** 工作区浏览器页槽：略高于主区，减轻 WebView 透底闪烁。 */
export const DESKTOP_MICA_BROWSER_TINT_CLASS = "bg-background/55";

/** 工作区终端：保留较高不透明度以保证 ANSI 可读性。 */
export const DESKTOP_MICA_TERMINAL_TINT_CLASS = "bg-background/85";
...
export function desktopMicaWorkspaceTabSelectedClass(useMicaBackdrop: boolean): string {
  return useMicaBackdrop ? "bg-background/20" : SOLID_BACKGROUND_CLASS;
}

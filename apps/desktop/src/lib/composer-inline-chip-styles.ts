 ...
 */
export const MESSAGE_BUBBLE_CHIP_CLASS = `inline-flex items-center gap-1 whitespace-nowrap px-0.5 py-0.5 text-sm ${FONT_WEIGHT_NORMAL} leading-none mx-0.5 ${COMPOSER_INLINE_CHIP_TEXT_CLASS}`;

...
mod tests {
    ...
    fn help_text_mentions_bottom_form_shortcuts() {
        ...
        assert!(help_text().contains("/model add"));
        assert!(help_text().contains("底部表单"));

...
enum ModelAction {
    ...
    Add {
        ...
        #[arg(long, value_name = "provider", value_parser = ["deepseek", "xai", "moonshot-ai", "kimi-code", "z-ai", "zhipu-ai", "minimax", "xiaomi", "siliconflow", "alibaba", "anthropic", "vercel-ai-gateway", "openrouter", "fireworks-ai", "together-ai", "groq", "deepinfra", "baseten", "hugging-face", "cohere", "openai", "google", "volcengine", "azure", "amazon-bedrock", "custom"])]

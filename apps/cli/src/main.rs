...
enum ModelAction {
    ...
    Add {
        ...
        #[arg(long, value_parser = ["deepseek", "xai", "moonshot-ai", "z-ai", "minimax", "xiaomi", "alibaba", "anthropic", "vercel-ai-gateway", "openrouter", "openai", "google", "volcengine", "azure", "amazon-bedrock", "custom"])]

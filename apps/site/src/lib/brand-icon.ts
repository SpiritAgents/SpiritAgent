...
export function spiritAgentTitleBarIconSrc(_dark: boolean, useTranslucency: boolean): string {
  return useTranslucency ? SPIRIT_AGENT_ICON_TRANSLUCENCY_SRC : SPIRIT_AGENT_ICON_DARK_SRC;
}

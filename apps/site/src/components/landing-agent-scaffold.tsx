...
import { LANDING_FEATURE_FRAME_CLASS, LANDING_FEATURE_GRID_CLASS } from "@/lib/site-layout";
import { FONT_WEIGHT_MEDIUM } from "@/lib/typography";

export function LandingAgentScaffold() {
  ...
  return (
    ...
    >
      ...
      >
        <section className={LANDING_FEATURE_GRID_CLASS}>
          <div className="flex h-full items-center">
            <div className="max-w-xl space-y-4">
              ...
              >
                ...
                <br />
                {messages.landing.agent.featureHeading[1]}
                <br />

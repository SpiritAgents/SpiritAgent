...
export function GlassLogoShowcase() {
  ...
  return (
    <div className="relative z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-background px-5 py-28 sm:py-32 lg:py-40">
      ...
      <div className="relative z-10 mt-5 flex flex-col items-center gap-5 sm:mt-6 sm:gap-6">
        <p
          className={`text-[clamp(2rem,5vw,4rem)] ${FONT_WEIGHT_MEDIUM} leading-none tracking-[-0.05em] text-foreground`}
        >

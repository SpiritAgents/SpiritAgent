...
type HoverDetailTooltipContextValue<TItem> = {
  ...
  onTriggerZonePointerLeave: ReturnType<
    typeof useAnchoredItemSwitch<TItem>
  >["onTriggerZonePointerLeave"];
  contentRef: ReturnType<typeof useAnchoredItemSwitch<TItem>>["contentRef"];
  contentInteractionProps: ReturnType<
    typeof useAnchoredItemSwitch<TItem>
  >["contentInteractionProps"];
  activeItem: TItem | null;
};

const HoverDetailTooltipContext = createContext<HoverDetailTooltipContextValue<any> | null>(null);
...
export function useHoverDetailTooltipState<TItem>(
  options: UseHoverDetailTooltipStateOptions<TItem>,
) {

...
Spirit은 개발자 원격 측정을 제공하지 않습니다. 데이터는 데이터 디렉터리와 키링에 유지됩니다. 저장소의 [PRIVACY.md](https://github.com/SpiritAgents/spirit/blob/main/PRIVACY.md)를 참조하세요.

취약점은 공개 이슈가 아닌 비공개로(GitHub Private Advisory) 보고하세요. [SECURITY.md](https://github.com/SpiritAgents/spirit/blob/main/SECURITY.md)를 참조하세요.

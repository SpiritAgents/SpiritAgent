---
title: Desktop
description: Settings map, Files / Git / Browser, marketplace, automations, and local Web Host pairing.
---
...
| --- | --- | --- |
| Basics | General | Notifications, tray / menu bar icon |
| | Appearance | Theme, font, UI language, mica / blur, pointer |
| Capabilities | Models | Provider connect, model list, keys |
| | Agents | LSP, commit / PR attribution |
| | Tab | Editor [Tab completion](./tools/tab-completion.mdx) |
...
| Connect | Networks | LLM HTTP version, **Web Remote Access** |
...
| Git | Changes, history, [commit / push / merge chips](./tools/git.mdx) |

---
title: Security
description: Keyring, approvals, and the loopback daemon. No telemetry, no billing page.
---
...
There is no Spirit billing or account page. Usage is whatever your [provider](./providers/index.mdx) charges.

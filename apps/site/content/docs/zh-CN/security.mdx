...
API Key、Bedrock / Vertex 密钥、扩展密钥和 GitHub 集成 token 存在操作系统钥匙串。服务名是 `Spirit`。
...
Spirit 不发送开发者遥测。数据留在数据目录和钥匙串。见仓库里的 [PRIVACY.md](https://github.com/SpiritAgents/spirit/blob/main/PRIVACY.md)。

漏洞请走私下渠道（GitHub Private Advisory），不要开公开 issue。见 [SECURITY.md](https://github.com/SpiritAgents/spirit/blob/main/SECURITY.md)。

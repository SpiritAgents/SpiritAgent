...
API 金鑰、Bedrock / Vertex 機密、擴充功能機密，以及 GitHub 整合權杖都儲存在作業系統的鑰匙圈中。服務名稱為 `Spirit`。
...
Spirit 不搭載開發者遙測。資料保留在資料目錄與鑰匙圈中。請參閱存放庫中的 [PRIVACY.md](https://github.com/SpiritAgents/spirit/blob/main/PRIVACY.md)。

請私下回報漏洞（GitHub 私人安全公告），不要公開在問題中。請參閱 [SECURITY.md](https://github.com/SpiritAgents/spirit/blob/main/SECURITY.md)。

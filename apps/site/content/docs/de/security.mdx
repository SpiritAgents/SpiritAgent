...
Spirit enthält keine Entwickler-Telemetrie. Daten bleiben im Datenverzeichnis und im Schlüsselbund. Siehe [PRIVACY.md](https://github.com/SpiritAgents/spirit/blob/main/PRIVACY.md) im Repository.

Melden Sie Schwachstellen privat (GitHub Private Advisory), nicht in einem öffentlichen Issue. Siehe [SECURITY.md](https://github.com/SpiritAgents/spirit/blob/main/SECURITY.md).

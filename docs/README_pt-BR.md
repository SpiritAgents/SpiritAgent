...
**Requisitos:** Node.js 24+, pnpm 10+ (ativar via `corepack enable`). Toolchain Rust necessária para build da CLI.
...
| `pnpm run build` | Build de produção de agent-core, host-internal, server, acp-server e Desktop |
